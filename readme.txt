...
Contributors: dynco, mattjwilding
Donate link: http://dynco.co.uk/
...
### For more information, visit the [plugin information page](http://dynco.co.uk/services/wordpress-toolkit-plugin)

Learn about setting up the plugin, how to configure the shortcode, template overrides and more on the [plugin info page](http://dynco.co.uk/services/wordpress-toolkit-plugin).
